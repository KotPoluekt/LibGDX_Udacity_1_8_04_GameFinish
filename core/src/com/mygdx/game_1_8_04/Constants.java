...
public class Constants {
    ...
    public static final float FOLLOW_MULTIPLIER = 5.0f;
    ...
    public static final float EASY_SPAWNS_PER_SECOND = 4;
    public static final float MEDIUM_SPAWNS_PER_SECOND = 8;
